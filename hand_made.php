...
?>
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<a class="zoomTool" href="product_details.php?detail=<?php echo $data['p_id'];?>" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				...
				<div class="caption cntr">
					...
					<h4><form method="post" action="hand_made.php"><label>Qunatity: <input type="text" name="qunty" style="width: 32px; height: 20px;"> </label></form>


						<a class="shopBtn" href="add_to_cartprocess.php?id_no=<?php echo $data['p_id'];?>" title="add to cart"> Add to cart </a></h4>
