	...
	<div class="well np">
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
			  <div class="item">
                <img style="width:100%" src="exter/img/1.jpg" alt=" ecommerce ">
			  ...
			  <div class="item">
                <img style="width:100%" src="exter/img/2.jpg" alt=" ecommerce ">
                <div class="carousel-caption">
                      <h4> Ecommerce </h4>
			  ...
			  <div class="item active">
                <img style="width:100%" src="exter/img/3.jpg" alt=" ecommerce ">
                <div class="carousel-caption">
                      <h4>amit</h4>
              ...
              <div class="item">
                <img style="width:100%" src="exter/img/4.jpg" alt=" ecommerce">
                <div class="carousel-caption">
                      <h4>Aryan</h4>
		...
		<div id="newProductCar" class="carousel slide">
			...
			<div class="item active">
			  <ul class="thumbnails">
				...
				<div class="thumbnail">
					<a class="zoomTool" href="product_details.php" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
					<a href="#" class="tag"></a>
					<a href="product_details.php"><img src="exter/img/images (1).jpg" alt="bootstrap-ring"></a>
				</div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
				...
				<li class="span3">
				  <div class="thumbnail">
					<a class="zoomTool" href="product_details.php" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
					<a href="#" class="tag"></a>
					<a  href="product_details.php"><img src="exter/img/toyinsidermack1.jpg" alt=""></a>
				  </div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
					<a class="zoomTool" href="product_details.php" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
					<a  href="product_details.php"><img src="exter/img/486.jpg" alt=""></a>
				  </div>
				</li>
			  </ul>
			  </div>
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a class="zoomTool" href="product_details.php" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<a  href="product_details.php"><img src="exter/img/kong-wild-knots-squeaker-bears-dog-toy-medium-large-assorted-3.jpg" alt=""></a>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
			  ...
			  <div class="thumbnail">
				...
				<div class="caption">
				  ...
				  <h4>
					  ...
					  <span class="pull-right">RS 22.00</span>
				  </h4>
				</div>
			  </div>
			</li>
